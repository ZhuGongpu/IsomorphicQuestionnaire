...
})(this, function(__WEBPACK_EXTERNAL_MODULE_83__, __WEBPACK_EXTERNAL_MODULE_189__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Relocate = __webpack_require__(107);

	var _Relocate2 = _interopRequireDefault(_Relocate);

	var _reselect = __webpack_require__(111);

	var _Question = __webpack_require__(112);
	...
	var mapStateToProps = function mapStateToProps(state, props) {
	    ...
	    var selectAnswers = selectors.selectAnswers;


	    return (0, _reselect.createSelector)(selectAnswers(), function (answers) {
	        return { answers: answers };
	    });
	};

	function mapDispatchToProps(dispatch, props) {
	    var actionCreators = props.actionCreators;
	    var answerChange = actionCreators.answerChange;

	    //TODO: if onAnswerChange is defined in parents, return an empty object.

	    return {
	        onAnswerChange: function onAnswerChange(questionId, answer) {
	            return dispatch(answerChange(questionId, answer));
	        }
	    };
	}

	exports.default = (0, _Relocate2.default)(_actions2.default, _reducer2.default, _selectors2.default)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Questionnaire));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindActionCreators = __webpack_require__(102);

	var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);

	var _applyMiddleware = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getClassDisplayName = __webpack_require__(110);

	var _getClassDisplayName2 = _interopRequireDefault(_getClassDisplayName);
	 ...
	 */
	var relocate = function relocate(makeActionCreators, makeReducer, makeSelectors) {
	    return function (ComposedComponent) {
	        var RelocatableComponent = function (_React$Component) {
	            _inherits(RelocatableComponent, _React$Component);

	            function RelocatableComponent(props) {
	                _classCallCheck(this, RelocatableComponent);

	                var _this = _possibleConstructorReturn(this, (RelocatableComponent.__proto__ || Object.getPrototypeOf(RelocatableComponent)).call(this, props));

	                var _this$props = _this.props;
	                var domain = _this$props.domain;
	                var actionPrefix = _this$props.actionPrefix;


	                _this.actionCreators = makeActionCreators(actionPrefix);
	                _this.selectors = makeSelectors(domain);
	                _this.reducer = makeReducer(_this.actionCreators);

	                _this.LazyLoadingComponent = (0, _LazyLoad2.default)(domain, _this.reducer)(ComposedComponent);
	                RelocatableComponent.displayName = "Relocate(" + (0, _getClassDisplayName2.default)(_this.LazyLoadingComponent) + ")";
	                return _this;
	            }

	            _createClass(RelocatableComponent, [{
	                key: "render",
	                value: function render() {
	                    return _react2.default.createElement(this.LazyLoadingComponent, _extends({ actionCreators: this.actionCreators,
	        ...
	        RelocatableComponent.propTypes = {
	            ...
	            actionPrefix: _react2.default.PropTypes.string.isRequired
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hooks = __webpack_require__(109);
	...
	var lazyLoad = function lazyLoad(domain, reducer) {
	    return function (ComposedComponent) {
	        var LazyLoadingComponent = function (_React$Component) {
	            _inherits(LazyLoadingComponent, _React$Component);

	            function LazyLoadingComponent() {
	                _classCallCheck(this, LazyLoadingComponent);

	                return _possibleConstructorReturn(this, (LazyLoadingComponent.__proto__ || Object.getPrototypeOf(LazyLoadingComponent)).apply(this, arguments));
	            }

	            _createClass(LazyLoadingComponent, [{
	                key: "componentWillMount",
	                value: function componentWillMount() {
	                    var _getHooks = (0, _hooks.getHooks)(this.context.store);

	                    var injectReducer = _getHooks.injectReducer;
	        ...
	        LazyLoadingComponent.displayName = "LazyLoad(" + (0, _getClassDisplayName2.default)(ComposedComponent) + ")";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducers = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../reducers.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	function injectAsyncReducer(store) {
	  return function (name, asyncReducer) {
	    ...
	    // console.info("injectAsyncReducer: store: %o", store);
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Matrix = __webpack_require__(298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcCheckbox = __webpack_require__(116);
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shallowCompare = __webpack_require__(120);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _radioButton = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcRadio = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Checkbox = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculateNodeHeight = __webpack_require__(137);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcSelect = __webpack_require__(145);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Option = __webpack_require__(295);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcAnimate = __webpack_require__(237);

	var _rcAnimate2 = _interopRequireDefault(_rcAnimate);

	var _componentClasses = __webpack_require__(243);
	...
	var _FilterMixin = __webpack_require__(293);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits2 = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(156)(IteratorPrototype, __webpack_require__(208)('iterator'), function(){ return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(154)(Function.call, __webpack_require__(225).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChildrenUtils = __webpack_require__(239);

	var _AnimateChild = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Event = __webpack_require__(242);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createChainedFunction = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _guid = __webpack_require__(259);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contains = __webpack_require__(265);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addDomEventListener = __webpack_require__(262);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventObject = __webpack_require__(263);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventBaseObject = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcTrigger = __webpack_require__(271);
	...
	var _DropdownMenu = __webpack_require__(292);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getContainerRenderMixin = __webpack_require__(291);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PopupInner = __webpack_require__(288);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domAlign = __webpack_require__(278);
	...
	var _isWindow = __webpack_require__(287);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getVisibleRectForElement = __webpack_require__(282);

	var _getVisibleRectForElement2 = _interopRequireDefault(_getVisibleRectForElement);

	var _adjustForViewport = __webpack_require__(283);

	var _adjustForViewport2 = _interopRequireDefault(_adjustForViewport);

	var _getRegion = __webpack_require__(284);

	var _getRegion2 = _interopRequireDefault(_getRegion);

	var _getElFuturePos = __webpack_require__(285);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _propertyUtils = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getAlignOffset = __webpack_require__(286);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcRate = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Rate = __webpack_require__(301);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Star = __webpack_require__(303);
...
/***/ function(module, exports) {
	...
	var makeQuestionnaireActions = function makeQuestionnaireActions(actionPrefix) {
	    var ANSWER_CHANGE = actionPrefix + "ANSWER_CHANGE";
	    var answerChange = function answerChange(question_id, answer) {
	        return {
	            type: ANSWER_CHANGE, question_id: question_id, answer: answer
	        };
	    };

	    return {
	        ANSWER_CHANGE: ANSWER_CHANGE, answerChange: answerChange
	    };
	};

	exports.default = makeQuestionnaireActions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _immutable = __webpack_require__(312);
	 ...
	 * Created by ZhuGongpu on 16/8/29.
	 */
	var createQuestionnaireSelector = function createQuestionnaireSelector(domain) {
	    var selectQuestionnaireDomain = function selectQuestionnaireDomain() {
	        return function (state) {
	            return (0, _immutable.fromJS)(state.get(domain));
	        };
	    };

	    var selectAnswers = function selectAnswers() {
	        return (0, _reselect.createSelector)(selectQuestionnaireDomain(), function (state) {
	            return state.get("answers").toJS();
	        });
	    };

	    return {
	        selectQuestionnaireDomain: selectQuestionnaireDomain,
	        selectAnswers: selectAnswers
	    };
	};

	exports.default = createQuestionnaireSelector;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Created by ZhuGongpu on 16/8/29.
	 */
	var makeQuestionnaireReducer = function makeQuestionnaireReducer(actions) {
	    var ANSWER_CHANGE = actions.ANSWER_CHANGE;
	    ...
	    var answers = function answers() {
	        ...
	        switch (action.type) {
	            case ANSWER_CHANGE:
	                return state.set(action.question_id, (0, _immutable.fromJS)(action.answer));
	            default:
	                return state;
	        }
	    };

	    return (0, _redux.combineReducers)({ answers: answers });
	};

	exports.default = makeQuestionnaireReducer;
